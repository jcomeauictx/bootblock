...
fetch the bootblock from the disk partition: dd if=/dev/sdb1 bs=512 count=1 of=sdb1.boot.dat

attempt disassembly: objdump --disassemble-all > sdb1.boot.dat > sdb1.boot.dsm
